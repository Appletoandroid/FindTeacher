...
public class TeacherDetailsResponse implements Parcelable
{
    ...
    public final static Parcelable.Creator<TeacherDetailsResponse> CREATOR = new Creator<TeacherDetailsResponse>() {

        @SuppressWarnings({"unchecked"})
        public TeacherDetailsResponse createFromParcel(Parcel in) {
            return new TeacherDetailsResponse(in);
        }
